...
Probably it will become more flat, since the sampling variation goes
down.
...
We made 10 coin-flipping scenarios to see how many heads we get, and
repeated it for 1,000 times to see the overall distribution
...
I see a huge histogram depicting the count of 1,000 sample means in
total. It looks like it's bell shaped.
